@echo off
REM Jonah WAR-LEVEL prototype launcher: opens "Balaam raised hands" (Numbers 22) directly.
REM English-only (Chinese breaks .bat parsing on Windows).
setlocal enableextensions
title Jonah War Level - Balaam
cd /d "%~dp0"

echo ============================================
echo    War Level: Balaam (Numbers 22)  -  starting...
echo ============================================
echo.
...
set "URL=http://localhost:%PORT%/?level=balaam"
echo.
echo  Game URL:  %URL%
echo.
