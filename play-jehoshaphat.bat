@echo off
REM Jonah WAR-LEVEL prototype launcher: opens "Jehoshaphat raised hands" (2 Chron 20) directly.
REM English-only (Chinese breaks .bat parsing on Windows).
setlocal enableextensions
title Jonah War Level - Jehoshaphat
cd /d "%~dp0"

echo ============================================
echo    War Level: Jehoshaphat (2 Chron 20)  -  starting...
echo ============================================
echo.
...
set "URL=http://localhost:%PORT%/?level=jehoshaphat"
echo.
echo  Game URL:  %URL%
echo.
