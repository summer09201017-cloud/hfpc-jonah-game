@echo off
REM Jonah WAR-LEVEL prototype launcher: opens "Moses raised hands" (Exodus 17) directly.
REM English-only (Chinese breaks .bat parsing on Windows).
setlocal enableextensions
title Jonah War Level - Moses
cd /d "%~dp0"

echo ============================================
echo    War Level: Moses (Exodus 17)  -  starting...
echo ============================================
echo.
...
set "URL=http://localhost:%PORT%/?level=moses"
echo.
echo  Game URL:  %URL%
echo.
